...
<div class="flex justify-center w-full">
    ...
    @endif
    <div class="flex min-h-full flex-col my-10 justify-center px-6 py-12 lg:px-8 primary p-4 w-3/6 rounded-md shadow-md bg-gray-100">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm ">
            <img class="mx-auto h-10 w-auto" src="{{ asset('images/logosss.jpg') }}" alt="logo">
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create New Product</h2>
        </div>
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm primary">
            <form class="space-y-6" action="{{ route('admin.storeProduct') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div>
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold p-2 rounded w-full">Create</button>
                </div>
            </form>
