...
@section('content')
    ...
    <div class="flex justify-center w-full">
        ...
        @endif
        <div
            class="flex min-h-full flex-col my-10 justify-center px-6 py-12 lg:px-8 primary p-4 w-3/6 rounded-md shadow-md bg-gray-100">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm primary">
                <form class="space-y-6" action="{{ route('admin.storeProduct') }}" method="POST"
                    ...
                    <div>
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-700 text-white font-semibold p-2 rounded w-full">Create</button>
                    </div>
                </form>
